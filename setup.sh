...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_require.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_apache2.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_socks.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_domain.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_menu.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_openvpn.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_stunnel.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_BBR.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/install_firewall_kvm.sh >/dev/null 2>&1
bash install_firewall_kvm.sh >/dev/null 2>&1
rm install_firewall_kvm.sh >/dev/null 2>&1
echo -e "\033[1;36m──────────────────────────────────────────────────────────\033[0m"
sleep 6
clear
wget https://raw.githubusercontent.com/mrtunneldo2024/old_ovpn/main/data/finish.sh
bash finish.sh
